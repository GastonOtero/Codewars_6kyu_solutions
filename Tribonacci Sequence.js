...
last 3 (instead of 2) numbers of the sequence to generate the next. And, worse part 
of it, regrettably I won't get to hear non-native Italian speakers trying to pronounce 
it :(
...
n == 0, then return an empty array (except in C return NULL) and be ready for anything 
...
function tribonacci(signature,n){
    ...
    return n >= 3 ? result : result.slice(0, n);
}
